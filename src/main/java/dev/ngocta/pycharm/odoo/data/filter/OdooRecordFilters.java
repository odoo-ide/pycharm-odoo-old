...
public class OdooRecordFilters {
    ...
    public static final OdooRecordFilter IR_UI_MENU = new OdooRecordModelFilter(OdooNames.IR_UI_MENU);
    public static final OdooRecordFilter IR_MODEL = new OdooRecordModelFilter(OdooNames.IR_MODEL);
