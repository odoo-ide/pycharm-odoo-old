...
public class OdooExternalIdReferenceProvider extends PsiReferenceProvider {
    public static final Key<Computable<String[]>> MODELS_RESOLVER = new Key<>("modelsResolver");
    ...
    public PsiReference[] getReferencesByElement(@NotNull PsiElement element,
        ...
        Computable<String[]> modelsResolver = context.get(MODELS_RESOLVER);
        ...
        if (Boolean.TRUE.equals(commaSeparated)) {
            return getCommaSeparatedReferences(element, modelsResolver, subType, Boolean.TRUE.equals(allowRelative));
        }
        return new PsiReference[]{new OdooExternalIdReference(element, null, modelsResolver, subType, Boolean.TRUE.equals(allowRelative))};
    }
    ...
    public static PsiReference[] getCommaSeparatedReferences(@NotNull PsiElement element,
        ...
        while (matcher.find()) {
            ...
            result.add(new OdooExternalIdReference(element, subRange, modelsResolver, subType, allowRelative));
        }
